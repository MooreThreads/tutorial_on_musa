...
class TestDetectors(unittest.TestCase):
    ...
    @unittest.skipIf(not TEST_MUSA, "no MUSA detected")
    def test_build_detectors_musa(self):
        ''' Make sure models build on gpu'''
        _test_build_detectors(self, "musa")
    ...
    @unittest.skipIf(not TEST_MUSA, "no MUSA detected")
    def test_run_selected_detectors_musa(self):
        ''' Make sure models build and run on musa '''
        # run on selected models
        cfg_files = get_config_files(CONFIG_FILES, None)
        # cfg_files = get_config_files(None, EXCLUDED_FOLDERS)
        _test_run_selected_detectors(self, cfg_files, "musa")
